...
import Diego.Utilidades;
import eredua.Departamentua;
import eredua.Enplegatua;
import Diego.InternalSys;
...
public class Bitacora {
    ...
    // maneje
    private final static Logger LOG_RAIZ = Logger.getLogger("Diego");
...
//    private final static Logger LOG_UNDER = Logger.getLogger("bitacora.subnivel.under");
    ...
    private final static Logger LOGGER = Logger.getLogger("Diego.Bitacora");
    ...
    public static void main(String[] args) {
        try {
            ...
            // todo el archivo
            Handler fileHandler = new FileHandler("C:\\Diego\\bitacora.log", false);
            ...
            ReadDepartJSON dep = new ReadDepartJSON();
            ReadEnpleJSON enp = new ReadEnpleJSON();
            ...
            dep.read(json, depArrayList);
            enp.read(json, enpArrayList);
